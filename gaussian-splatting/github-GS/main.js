...
async function main() {
    ...
    const url = params.get("url") || "https://huggingface.co/Michel-Lin/my-3d-models/resolve/main/github-GS.splat";
    const req = await fetch(url);
    console.log(req);
    if (!req.ok) {
        throw new Error(`${req.status} - Failed to load splat file: ${url}`);
    }
